...
%Pour faire de jolies citations encadrées
\usepackage{epigraph}
...
\fancyhead[L]{\includegraphics[height=1cm]{costech.png}}
\fancyhead[R]{\includegraphics[height=1cm]{utc.jpg}}
\fancyhead[C]{Rédaction Bibliographique de fin d'études\vspace{2mm}}
\fancyfoot[L]{Jonathan DEKHTIAR}
...
\geometry{a4paper, top=3cm, bottom=3cm, left=2.5cm, right=2.5cm, marginparwidth=2cm}
...
\chapter{La prévention des risques majeurs}
\include*{Parties/Prevention}

\chapter{La concertation, solution ou mirage ?}
\include*{Parties/LesLimites}
...
\href{https://github.com/DEKHTIARJonathan/Rapport-BC01}{\textbf{https://github.com/DEKHTIARJonathan/Rapport-BC01}}. 

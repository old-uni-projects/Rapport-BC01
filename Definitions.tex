\chapter*{Les définitions importantes}
\markboth{Les définitions importantes}{}
\addcontentsline{toc}{chapter}{Les définitions importantes}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=4.75cm]{defineRecap.jpg}
